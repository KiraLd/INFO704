...
Program.prototype =
{
  ...
  use: function ()
  {
	...
	this.position = this.gl.getAttribLocation(this.id, "position");
	this.couleur = this.gl.getAttribLocation(this.id, "couleur");
	this.textCoord = this.gl.getAttribLocation(this.id, "aTextureCoord");
	this.gl.enableVertexAttribArray(this.position); 
	this.gl.enableVertexAttribArray(this.couleur); 
	this.gl.enableVertexAttribArray(this.textCoord);
  }
};
